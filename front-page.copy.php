...
<main>
  ...
  <section class="hero">
    ...
    <!-- Newsカード -->
    <a href="news-detail.html" class="hero__news-card">
        <div class="hero__news-header">
          <span class="hero__news-label english-text">News</span>
        </div>
        <div class="hero__news-date"><time>YYYY.MM.DD</time></div>
        <div class="hero__news-title">タイトルが入ります。タイトルが入り...</div>
      </a>
      ...
      <div class="news__layout">
        <div class="news__left">
          ...
          <div class="news__view-more">
            <a href="news.html" class="btn btn--primary english-text">View More</a>
          </div>
        </div>
          ...
          <div class="news__list">
            <article class="news__item">
              <div class="news__item-meta">
                <div class="news__item-date"><time>YYYY.MM.DD</time></div>
                <div class="news__item-category">カテゴリ</div>
              </div>
              <div class="news__item-content">
                <h3 class="news__item-title">タイトルが入ります。タイトルが入ります。タイトルが入ります。</h3>
              </div>
            </article>
    ...
    <div class="contact__container">
      <div class="contact__card">
        ...
        <div class="contact__button-wrapper">
          <a href="#contact-form" class="btn btn--primary english-text">お問い合わせ</a>
        </div>

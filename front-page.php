...
<main>
  ...
  <section class="hero">
    <div class="hero__content">
      <div class="hero__logo">
        <img src="<?php echo get_theme_file_uri('images/logo.svg'); ?>" width="169" height="29" alt="自然の恵み農園ロゴ">
      </div>
      ...
      <div class="farm__intro">
        ...
        <div class="farm__images">
          <div class="farm__image-item farm__image-goat">
            <img src="<?php echo get_theme_file_uri('images/about-image01.png'); ?>" width="400" height="504" alt="ヤギ" loading="lazy">
          </div>
          <div class="farm__image-item farm__image-tomato">
            <img src="<?php echo get_theme_file_uri('images/about-image02.png'); ?>" width="362" height="434" alt="トマト" loading="lazy">
          </div>
          <!-- 農園説明文 -->
          ...
          <div class="farm__image-item farm__image-farmer">
            <img src="<?php echo get_theme_file_uri('images/about-image03.png'); ?>" width="400" height="400" alt="農作業" loading="lazy">
          </div>
          <div class="farm__image-item farm__image-cow">
            <img src="<?php echo get_theme_file_uri('images/about-image04.png'); ?>" width="400" height="538" alt="牛" loading="lazy">
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-nouen01.png'); ?>" width="600" height="500" alt="農園の畑" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-nouen02.png'); ?>" width="600" height="500" alt="収穫作業" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-nouen03.png'); ?>" width="600" height="500" alt="新鮮なイチゴ" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-nouen04.png'); ?>" width="600" height="500" alt="農園スタッフ" loading="lazy">
                </div>
              </div>
              <!-- 無限ループ用の複製スライド -->
              <div class="swiper-slide">
        ...
        <div class="activities__tab-content" id="ranch_content">
          ...
          <div class="swiper activities__swiper" id="ranch_swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-bokujo01.png'); ?>" width="600" height="500" alt="牧場の動物" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-bokujo02.png'); ?>" width="600" height="500" alt="搾乳体験" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-bokujo03.png'); ?>" width="600" height="500" alt="動物とのふれあい" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-bokujo04.png'); ?>" width="600" height="500" alt="牧場の牛" loading="lazy">
                </div>
              </div>
              <!-- 無限ループ用の複製スライド -->
              <div class="swiper-slide">
        ...
        <div class="activities__tab-content" id="online_content">
          ...
          <div class="swiper activities__swiper" id="online_swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec01.png'); ?>" width="600" height="500" alt="オンライン販売商品一覧：はちみつシロップのかかったアイス" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec02.png'); ?>" width="600" height="500" alt="農園で育った牛のチーズ" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <blockquote>
                    <img src="<?php echo get_theme_file_uri('images/nouen-ichigojam.jpg'); ?>"width="600" height="500" alt="いちごジャム" loading="lazy">
                    <p><cite>出典:ゆきもと農園：https://shop.yukimoto-farm.com/</cite></p>
                  </blockquote>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec04.png');  ?>" width="600" height="500" alt="旬の野菜詰め合わせ" loading="lazy">
                </div>
              </div>
              <!-- 無限ループ用の複製スライド -->
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec01.png'); ?>" width="600" height="500" alt="オンライン販売商品1" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec02.png'); ?>" width="600" height="500" alt="オンライン販売商品2" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec03.png'); ?>" width="600" height="500" alt="オンライン販売商品3" loading="lazy">
                </div>
              </div>
              <div class="swiper-slide">
                <div class="activities__image">
                  <img src="<?php echo get_theme_file_uri('images/work-ec04.png'); ?>" width="600" height="500" alt="オンライン販売商品4" loading="lazy">
                </div>
              </div>
            </div>
          </div>
  ...
  <section id="faq" class="faq">
    <div class="faq__container">
      ...
      <?php $get_group = SCF::get('qanda'); ?>
      <?php foreach ($get_group as $field) { ?>
      <div class="faq__list">
        <div class="faq__item faq__item--active">
          <button class="faq__question">
            <span class="faq__q-icon">Q</span>
            <span class="faq__question-text"><?php echo nl2br($field['question']); ?></span>
            <span class="faq__toggle-icon"></span>
          </button>
          <div class="faq__answer">
            <div class="faq__answer-content">
              <span class="faq__a-icon">A</span>
              <div class="faq__answer-text">
                <p><?php echo nl2br($field['answer']); ?></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="news__layout">
          <div class="news__left">
            ...
            <div class="news__view-more">
              <a href="<?php echo home_url('/news/'); ?>" class="btn btn--primary english-text">自然農園めぐみ通信一覧はこちら</a>
            </div>
          </div>
      ...
      <div class="access__layout">
        ...
        <div class="access__value-wrapper">
          <div class="access__value access__value--card">
            <a href="<?php echo home_url('/'); ?>" class="access__value">株式会社自然の恵み農園</a>
            <a href="<?php echo home_url('/'); ?>" class="access__value">〒123-4567 千葉県○○市××町1丁目23-45</a>
            <a href="<?php echo home_url('/'); ?>" class="access__value">012-3456-7890</a>
    ...
    <div class="contact__container">
      <div class="contact__card">
        ...
        <div class="contact__button-wrapper">
          ...
          <a target="_blank" rel="noopener noreferrer" href="<?php echo home_url('/contact/'); ?>" class="btn btn--primary english-text">お問い合わせフォーム</a>
        </div>
